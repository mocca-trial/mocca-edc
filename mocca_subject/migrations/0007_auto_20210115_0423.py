...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='dminitialreview',
            name='dx_location',
            field=models.CharField(choices=[('hospital', 'Hospital'), ('gov_clinic', 'Government clinic'), ('private_clinic', 'Private clinic'), ('private_doctor', 'Private doctor'), ('mocca_clinic', 'MOCCA study clinic'), ('unknown', "Don't recall"), ('OTHER', 'Other, specify')], max_length=25, verbose_name='Where was the diagnosis made?'),
        ),
        migrations.AlterField(
            model_name='historicaldminitialreview',
            name='dx_location',
