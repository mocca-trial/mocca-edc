    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinic_type', models.CharField(choices=[('hiv_clinic', 'HIV Clinic'), ('ncd_clinic', 'NCD Clinic (Joint Diabetes/Hypertension)'), ('diabetes_clinic', 'Diabetes Clinic'), ('hypertension_clinic', 'Hypertension Clinic'), ('integrated', 'Integrated Clinic')], default='integrated', editable=False, max_length=25, verbose_name='From which type of clinic was the patient selected?')),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=1, null=True, verbose_name='Gender')),
                ('identity_type', models.CharField(choices=[('country_id', 'Country ID number'), ('drivers', "Driver's license"), ('passport', 'Passport'), ('clinic_no', 'Clinic number'), ('hospital_no', 'Hospital number'), ('mobile_no', 'Mobile number'), ('OTHER', 'Other')], max_length=25, verbose_name='What type of identity number is this?')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'first_name', 'dob', 'initials', 'version'], name='mocca_conse_subject_23d067_idx'),
        ),
