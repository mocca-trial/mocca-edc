    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_in_years', models.IntegerField(validators=[django.core.validators.MinValueValidator(18), django.core.validators.MaxValueValidator(110)])),
                ('dob', models.DateField()),
                ('mocca_site', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mocca_lists.MoccaOriginalSites')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mocca_study_identifier', models.CharField(help_text='Format must match original identifier. e.g. 12-3456 for UG, 123456 for TZ', max_length=25, verbose_name='Original MOCCA study identifier')),
                ...
                ('mocca_site', models.ForeignKey(limit_choices_to=mocca_screening.mocca_original_sites.get_mocca_site_limited_to, on_delete=django.db.models.deletion.PROTECT, to='mocca_screening.MoccaRegister', verbose_name='Original MOCCA site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mocca_site', models.ForeignKey(blank=True, db_constraint=False, limit_choices_to=mocca_screening.mocca_original_sites.get_mocca_site_limited_to, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='mocca_screening.MoccaRegister', verbose_name='Original MOCCA site')),
