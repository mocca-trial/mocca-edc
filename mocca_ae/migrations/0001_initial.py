    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_datetime', models.DateTimeField(validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and Time of Death')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_report', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='mocca_ae.DeathReport')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('ae_initial', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='mocca_ae.AeInitial')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.ActionItem')),
                ('cause_of_death', models.ForeignKey(help_text='Main cause of death in the opinion of the local study doctor and local PI', null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_adverse_event.CauseOfDeath', verbose_name='Main cause of death')),
                ('death_report', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mocca_ae.DeathReport')),
                ('parent_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.Site')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('officials_notified', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and time regulatory authorities notified (SUSARs)')),
                ('action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.ActionItem')),
                ('ae_initial', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mocca_ae.AeInitial')),
                ('parent_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.Site')),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='mocca_ae_de_subject_1a5954_idx'),
        ),
        migrations.AddIndex(
            model_name='deathreport',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='mocca_ae_de_subject_a8e113_idx'),
        ),
        migrations.AddIndex(
            model_name='aetmg',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='mocca_ae_ae_subject_8bff36_idx'),
        ),
        migrations.AddIndex(
            model_name='aesusar',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='mocca_ae_ae_subject_dda73c_idx'),
        ),
        migrations.AddIndex(
            model_name='aeinitial',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='mocca_ae_ae_subject_8f2445_idx'),
        ),
        migrations.AddIndex(
            model_name='aefollowup',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='mocca_ae_ae_subject_fe012e_idx'),
        ),
    ]
